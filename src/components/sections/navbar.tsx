...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-2 sm:px-6 lg:px-8 navbar-underline">
        {/* Logo / Brand */}
              ...
              <div className="mt-6 space-y-6 px-6">
                ...
                <nav className="space-y-1">
                  ...
                  <a
                    ...
                    className="flex items-center rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground text-foreground/60 hover:text-foreground cursor-pointer"
                    onClick={() => {
                      setIsOpen(false);
